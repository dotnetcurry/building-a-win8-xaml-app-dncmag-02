...
namespace Twittelytics
{
    ...
    /// </summary>
    public sealed partial class SplitPage : Twittelytics.Common.LayoutAwarePage
    {
        public SplitPage()
        {
        ...
        protected override void LoadState(Object navigationParameter, Dictionary<String, Object> pageState)
        {
            ...
            var group = TwitterDataSource.GetGroup((String)navigationParameter);
            if (group != null)
            {
            ...
            else
            {
                ...
                {
                    var selectedItem = TwitterDataSource.GetItem((String)pageState["SelectedItem"]);
        ...
        private void replyTweet_Click(object sender, RoutedEventArgs e)
        {
            var selectedItem = (TweetItem)this.itemsViewSource.View.CurrentItem;
